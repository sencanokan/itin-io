...
const post: BlogPost = {
  slug: "itin-expired-what-to-do",
  title: "ITIN Expired? Here's Exactly What to Do (2026 Guide)",
  description:
  ...
  keywords: [
    "ITIN expired",
    "expired ITIN what to do",
    "ITIN expired renewal",
    "how to renew expired ITIN",
    "ITIN expiration",
  ],
  content: `## Don't Panic - An Expired ITIN Is Completely Fixable
...
| Middle Digits | Expiration Date | Status in 2026 |
|:---:|:---:|:---:|
| 70, 71, 72, 73, 74, 75, 76, 77, 78, 79 | December 31, 2018 | Expired |
| 80, 81, 82, 83, 84, 85, 86, 87, 88 | December 31, 2019 | Expired |
| 90, 91, 92, 94, 95, 96, 97, 98, 99 | December 31, 2020 | Expired |
| 83, 84, 85, 86, 87 (issued before 2013) | December 31, 2021 | Expired |
| 70-88 (remaining) | December 31, 2022 | Expired |
| All remaining pre-2013 ITINs | Varies | Check with IRS |
...
For example:
- If you last filed using your ITIN for tax year 2022, it expires at the end of 2025
- If you last filed using your ITIN for tax year 2021, it's already expired in 2026
- If you used it for tax year 2023 or later, it's still active
...
If your dependent's ITIN is expired but yours is still valid:
- Your return will process normally
- Credits related to that dependent will be denied
- Only the dependent's ITIN needs renewal (not yours)
...
- Expert review prevents rejection
- No risk of document loss in mail
...
**Disadvantages**:
- Must mail original documents (or certified copies from issuing agency)
- Longest processing time
- Risk of document loss
- No expert review (higher rejection chance)
...
**Disadvantages**:
- Limited TAC office locations
- Must schedule appointment (can be weeks out)
- Must appear in person in the U.S.
...
## Important Things to Know About ITIN Renewal

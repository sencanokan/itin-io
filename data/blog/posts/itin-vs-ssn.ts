...
const post: BlogPost = {
  slug: "itin-vs-ssn-difference",
  title: "ITIN vs SSN: What's the Difference and Which Do You Need?",
  description:
    "Understand the key differences between an ITIN and SSN, who qualifies for each, and how to determine which tax identification number you need in 2026.",
  date: "2026-04-20",
  readTime: "8 min read",
  category: "Guide",
  keywords: [
    ...
    "ITIN or SSN",
    "do I need ITIN or SSN",
  ],
  content: `## What Is an SSN (Social Security Number)?
...
2. **Gather documents**: Proof of identity (passport), immigration status (visa, I-94, EAD card), and age (birth certificate)
3. **Visit your local Social Security office** in person
4. **Wait 2-4 weeks** to receive your card by mail
...
2. **Prepare your federal tax return** (must be attached unless you qualify for an exception)
3. **Gather identity documents**: Valid passport (or two alternative documents from the IRS list)
...
- Have valid work authorization in the U.S.
- Need to be employed by a U.S. company

**Choose ITIN if you:**
- Are a non-resident with U.S. tax obligations
- Own a U.S. LLC or business entity
- Have U.S. rental income or investments
- Need to file a U.S. tax return but cannot get an SSN
- Are the spouse or dependent of a U.S. taxpayer

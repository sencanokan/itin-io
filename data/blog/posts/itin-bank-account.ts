...
const post: BlogPost = {
  slug: "itin-for-us-bank-account",
  title: "Do I Need an ITIN to Open a U.S. Bank Account?",
  description:
  ...
  keywords: [
    "ITIN bank account",
    "open US bank account with ITIN",
    "ITIN banking",
    "US bank account without SSN",
    "ITIN for bank account",
  ],
  content: `## The Short Answer: Yes, You Can Open a U.S. Bank Account with an ITIN
...
| Bank | Personal Accounts | Business Accounts | Notes |
|------|:-:|:-:|-------|
| Bank of America | Yes | Yes | Requires in-branch visit; two forms of ID |
| Chase | Yes | Yes | Available in most states; may require appointment |
| Wells Fargo | Yes | Yes | Requires physical presence; additional docs may vary by state |
| Citibank | Yes | Yes | Good for international clients; available in select cities |

### Online & Fintech Banks

| Bank | Personal Accounts | Business Accounts | Notes |
|------|:-:|:-:|-------|
| Mercury | No | Yes | Popular for startups and LLCs; fully online application |
| Relay | No | Yes | Free business banking; integrates with accounting software |
| Wise (formerly TransferWise) | Yes | Yes | Multi-currency account; great for international transfers |
...
3. **Secondary ID** - one of the following:
   ...
   - U.S. state ID (if available)
   - Consular ID (Matricula Consular for Mexican nationals)
4. **Proof of U.S. address** - one of the following:
   - Utility bill (within 60 days)
   - Lease agreement
   - Bank or credit card statement
   - Letter from a U.S. government agency
5. **Initial deposit** (varies by bank, typically $25-$100)
...
Before approaching any bank, make sure you have your ITIN. The application process takes 2-10 weeks depending on your method. If you don't have an ITIN yet, [start your application with ITIN.io](/apply) to get it processed in as little as 2-4 weeks through our CAA service.
...
**Solution**: If you're newly arrived or don't have a traditional utility bill, consider these alternatives:
- A signed lease agreement (even for a short-term rental)
- A letter from your registered agent (for business owners)
- A virtual office agreement (accepted by some banks)
- Mail from a U.S. government agency

### Challenge 3: Physical Presence Required

**Solution**: If you're overseas and need a U.S. business account, consider:
- **Mercury or Relay**: These fintech banks allow fully remote business account opening
- **Wise Business**: Offers U.S. account details without requiring physical presence
- Planning a trip to the U.S. to open accounts in person
...
**Solution**: If traditional banks reject your application, try:
- Credit unions (more flexible policies)
- Community banks (more personalized service)
- Fintech options (different underwriting criteria)
- Bringing additional documentation to demonstrate financial stability
...
| Accepted at all banks | No (most major banks) | Yes (universal) |
| Can get a debit card | Yes | Yes |
| Can get a credit card | Yes (limited options) | Yes (full options) |
| Can build credit history | Yes | Yes |
| Online account opening | Limited (some fintechs) | Widely available |
| Account limits | Sometimes initially limited | Standard limits |
| International wire transfers | Yes | Yes |
| Required documents | More extensive | Standard |
| Processing time for approval | Same day to 1 week | Usually same day |
...
| Qualify for unsecured credit card | 12-18 months |
| Qualify for auto loan | 18-24 months |
| Qualify for mortgage | 24-36 months |
...
If your ITIN expires, your existing bank accounts remain open and functional. However, the bank may ask you to update your tax identification information. Renewing your ITIN is straightforward and doesn't affect your banking relationship. See our guide on [ITIN renewal](/blog/itin-expired-what-to-do) for details.
